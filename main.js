...
function loadSofa(index) {
    const modelFiles = [
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa1.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa2.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa3.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa4.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa5.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa6.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa7.glb',
        'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/sofa8.glb'
    ];
    ...
    const modelUrl = modelFiles[index]; // 直接使用CDN链接
...
const sofaHandleConfig = {
    0: { // Sofa 1
        Golden: { 
            position: { x: 0, y: -0.17, z: 2.18 }, 
            rotation: { x: THREE.MathUtils.degToRad(-10.3), y: 0, z: 0 }
        },
        Silver: { 
            position: { x: 0, y: -0.17, z: 2.18 },
            rotation: { x: THREE.MathUtils.degToRad(-10.3), y: 0, z: 0 } 
    ...
    5: { // Sofa 6
        Golden: { 
            position: { x: 0, y: -0.17, z: 2.25 }, 
            rotation: { x: THREE.MathUtils.degToRad(-10.1), y: 0, z: 0 } 
        },
        Silver: { 
            position: { x: 0, y: -0.17, z: 2.25 }, 
            rotation: { x: THREE.MathUtils.degToRad(-10.1), y: 0, z: 0 } 
...
// 更新拉手模型路径
const handleModels = {
    Golden: 'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/golden-handle.glb',
    Silver: 'https://cdn.jsdelivr.net/gh/capriceyi/zhongjiamobileterminal@v1.0.1/models/silver-handle.glb'
};
...
function selectHandle(handleType) {
    ...
    const loader = new THREE.GLTFLoader();
    loader.setDRACOLoader(dracoLoader);
    const handleUrl = handleModels[handleType]; // 直接使用CDN链接
    ...
    loader.load(
        ...
        undefined,
        (error) => {
            console.error('加载拉手模型时发生错误:', error);
        }
    );
}
...
// 动态添加颜色选择项
const mainColors248 = ['textures/ZJ-248-01.webp', 'textures/ZJ-248-02.webp', 'textures/ZJ-248-03.webp', 'textures/ZJ-248-04.webp', 'textures/ZJ-248-05.webp', 
    'textures/ZJ-248-06.webp', 'textures/ZJ-248-07.webp', 'textures/ZJ-248-08.webp', 'textures/ZJ-248-09.webp', 'textures/ZJ-248-10.webp',
    'textures/ZJ-248-11.webp', 'textures/ZJ-248-12.webp', 'textures/ZJ-248-13.webp'];
const mainColorsS600 = ['textures/ZJ-S600-01.webp', 'textures/ZJ-S600-02.webp', 'textures/ZJ-S600-03.webp', 'textures/ZJ-S600-04.webp', 'textures/ZJ-S600-05.webp',
    'textures/ZJ-S600-06.webp', 'textures/ZJ-S600-07.webp', 'textures/ZJ-S600-08.webp', 'textures/ZJ-S600-16.webp'];
const mainColorsW00 = ['textures/ZJ-W001.webp', 'textures/ZJ-W002.webp', 'textures/ZJ-W003.webp', 'textures/ZJ-W004.webp', 'textures/ZJ-W007.webp',
    'textures/ZJ-W010.webp', 'textures/ZJ-W011.webp', 'textures/ZJ-W012.webp', 'textures/ZJ-W013.webp', 'textures/ZJ-W014.webp'];
const accentColorsP248 = ['textures/ZJ-P248-01.webp', 'textures/ZJ-P248-02.webp', 'textures/ZJ-P248-03.webp', 'textures/ZJ-P248-04.webp', 'textures/ZJ-P248-05.webp',
    'textures/ZJ-P248-06.webp', 'textures/ZJ-P248-07.webp', 'textures/ZJ-P248-08.webp', 'textures/ZJ-P248-09.webp', 'textures/ZJ-P248-10.webp', 'textures/ZJ-P248-11.webp',
    'textures/ZJ-P248-12.webp', 'textures/ZJ-P248-13.webp', 'textures/ZJ-547-79.webp', 'textures/ZJ-547-26.webp', 'textures/ZJ-P248-23.webp', 'textures/ZJ-P248-24.webp',
    'textures/ZJ-P248-26.webp', 'textures/ZJ-P248-27.webp', 'textures/ZJ-P248-28.webp', 'textures/ZJ-P248-29.webp', 'textures/ZJ-P248-30.webp',
    'textures/ZJ-P248-31.webp'];
...
const accentColorsPW00 = ['textures/ZJ-PW001.webp',  'textures/ZJ-PW004.webp', 'textures/ZJ-PW008.webp', 'textures/ZJ-PW009.webp',  'textures/ZJ-PW010.webp','textures/ZJ-PW011.webp', 'textures/ZJ-PW012.webp'];
