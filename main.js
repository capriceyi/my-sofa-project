const BASE_URL = 'https://cdn.jsdelivr.net/gh/capriceyi/my-sofa-project@main/'; // 设置 jsDelivr 基础 URL
// 在文件顶部声明全局变量
...
function loadSofa(index) {
    ...
    const modelPath = BASE_URL + modelFiles[index];  // 拼接 jsDelivr URL
...
// 更新拉手模型路径
const handleModels = {
    Golden: 'models/golden-handle.glb',
    Silver: 'models/silver-handle.glb'
};
